...
RPOS 0.1.0a4 is the currently published Early Public Alpha. Its verified surface includes bounded executable Python behavior, persistence and recovery scenarios, Responsibility Routing, clean package installation, public-export reconstruction, SBOM and source-bound checks, Ubuntu/Windows Python 3.11/3.12 evidence, GitHub Pages validation, and six published Lean 4 responsibility invariants machine-checked in declared bounded models and cross-linked to Python runtime tests.
