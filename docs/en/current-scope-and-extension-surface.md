...
- additive Responsibility Routing for Human Gate, reconciliation hold, repair, and return-for-authorization while preserving `route_selection != authority_grant`;
